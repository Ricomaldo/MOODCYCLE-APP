//
// ─────────────────────────────────────────────────────────
// 📄 Fichier : app/onboarding/375-age.jsx
// 🧩 Type : Composant Écran (Screen)
// 📚 Description : Écran de sélection de la tranche d'âge de l'utilisatrice
// 🕒 Version : 3.0 - 2025-06-21
// 🧭 Utilisé dans : onboarding flow (étape 4)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//
...
const AGE_RANGES = [
  {
    ...
    label: "18-25 ans",
    icon: "🌱",
    description: "Découverte et exploration",
  },
  {
    key: "26-35",
    label: "26-35 ans",
    icon: "🌸",
    description: "Épanouissement personnel",
  },
  {
    key: "36-45",
    label: "36-45 ans",
    icon: "🌺",
    description: "Équilibre et maturité",
  },
  {
    key: "46-55",
    label: "46-55 ans",
    icon: "🌿",
    description: "Transition et sagesse",
  },
  {
    key: "55+",
    label: "55 ans et plus",
    icon: "🌳",
    description: "Sagesse accomplie",
  },
];
            ...
            {(step === 1 || step === 2) && (
              <View style={styles.ageContainer}>
                <BodyText style={styles.helpText}>
                  Cette information reste privée et m'aide à personnaliser mes
                  conseils
                </BodyText>
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        selectedAge === ageRange.key &&
                          styles.ageOptionSelected,
                      ]}
                      onPress={() => handleAgeSelect(ageRange.key)}
                      activeOpacity={0.7}
                    >
                      <BodyText style={styles.ageIcon}>
                        {ageRange.icon}
                      </BodyText>
