...
export const PERSONA_PROFILES = {
  ...
  clara: {
    ...
    name: "Clara",
    description:
      "Power user enthousiaste qui maximise toutes les fonctionnalités (26-35 ans)",
    ageRange: ["26-35"],
...
export const SCORING_WEIGHTS = {
  ...
  PREFERENCES: 0.4, // 40% - Préférences de santé (plus important)
  COMMUNICATION: 0.2, // 20% - Style de communication préféré
};
