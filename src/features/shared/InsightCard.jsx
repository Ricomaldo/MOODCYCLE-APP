//
// ─────────────────────────────────────────────────────────
// 📄 Fichier : src/features/shared/InsightCard.jsx
// 🧩 Type : Composant UI
// 📚 Description : Carte d’insight affichant une information ou un conseil selon la phase
...
export default function InsightCard({ insight, phase = 'menstrual' }) {
  ...
  const captionColor =
    textColor === '#FFFFFF' ? 'rgba(255, 255, 255, 0.8)' : 'rgba(33, 33, 33, 0.7)';
