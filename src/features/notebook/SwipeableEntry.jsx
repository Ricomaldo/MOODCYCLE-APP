//
// ─────────────────────────────────────────────────────────
// 📄 File: src/features/notebook/SwipeableEntry.jsx
// 🧩 Type: UI Component
// 📚 Description: Entrée de carnet swipeable avec actions (partage, tag, suppression)
// 🕒 Version: 3.0 - 2025-06-21
// 🧭 Used in: notebook screen, entry list, shared notebook UI
// ─────────────────────────────────────────────────────────
//
...
export default function SwipeableEntry({
  ...
  const handleLongPress = () => {
    Alert.alert('Actions', 'Que veux-tu faire ?', [
  ...
  return (
    ...
    >
      <View style={styles.entryHeader}>
        ...
        {item.metadata?.phase && (
          <View style={[styles.phaseDot, { backgroundColor: getPhaseDotColor() }]} />
        )}
      </View>
