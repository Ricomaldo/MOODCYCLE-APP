// components/Notebook/QuickTrackingModal.jsx
...
const SYMPTOMS = [
  ...
  { id: 'sensibilite', label: 'Sensibilité', color: theme.colors.phases.ovulatory },
  { id: 'maux_tete', label: 'Maux de tête', color: theme.colors.warning },
  { id: 'ballonnements', label: 'Ballonnements', color: theme.colors.phases.follicular },
];
              ...
              <View style={styles.energyDots}>
                {ENERGY_EMOJIS.map((emoji, index) => (
                  <TouchableOpacity 
                    ...
                    style={[
                      styles.energyDot,
                      energy === index && styles.energyDotActive
                    ]}
                  >
              ...
              <View style={styles.symptomsContainer}>
                {SYMPTOMS.map((symptom) => (
                  ...
                  >
                    <BodyText style={[
                      styles.symptomText,
                      symptoms.includes(symptom.id) && { color: symptom.color }
                    ]}>
                      {symptom.label}
                    </BodyText>
                  </TouchableOpacity>
