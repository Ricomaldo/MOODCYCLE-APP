...
export default function EntryDetailModal({ 
  ...
  const getEntryIcon = (type) => {
    ...
    switch (type) {
      ...
      case 'personal': return <MaterialIcons name="edit" {...iconProps} />;
      case 'tracking': return <MaterialIcons name="bar-chart" {...iconProps} />;
      default: return <MaterialIcons name="edit" {...iconProps} />;
    }
  };
                  ...
                  <View style={styles.navigationContainer}>
                    ...
                    >
                      <MaterialIcons 
                        name="chevron-right" 
                        size={20} 
                        color={currentIndex === entries.length - 1 ? theme.colors.textLight : theme.colors.primary} 
                      />
                    </TouchableOpacity>
                  </View>
                )}
